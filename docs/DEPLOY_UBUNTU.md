...
> [!NOTE]
> For production, these files should be provided via Docker secrets or mounted volumes, not committed to repo (`.env`, `server/fcm-service-account.json`, `app/google-services.json`).
